...
namespace MessageServer.ServiceReference1 {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private MessageServer.ServiceReference1.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public MessageServer.ServiceReference1.TranslationMatch[] Translations {
            get {
    ...
    public interface LanguageService {
        ...
        MessageServer.ServiceReference1.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, MessageServer.ServiceReference1.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, MessageServer.ServiceReference1.Translation[] translations, string from, string to, MessageServer.ServiceReference1.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        MessageServer.ServiceReference1.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, MessageServer.ServiceReference1.TranslateOptions options);
        ...
        MessageServer.ServiceReference1.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, MessageServer.ServiceReference1.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : MessageServer.ServiceReference1.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<MessageServer.ServiceReference1.LanguageService>, MessageServer.ServiceReference1.LanguageService {
        ...
        public MessageServer.ServiceReference1.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, MessageServer.ServiceReference1.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, MessageServer.ServiceReference1.Translation[] translations, string from, string to, MessageServer.ServiceReference1.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public MessageServer.ServiceReference1.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, MessageServer.ServiceReference1.TranslateOptions options) {
        ...
        public MessageServer.ServiceReference1.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, MessageServer.ServiceReference1.TranslateOptions options) {
